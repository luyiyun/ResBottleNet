...
# svm 1-8 rank_ratio=0.9-0.0 没跑完
#set -v
#for f in {0..9}
#do
...
#    for i in {1..8}
#    do
#        echo "#####################rank_ratio=${rr}, block_num=$i begin.#####################"
#        python3 train.py -d survival -s RESULTS/survdl${i}_cv10_drop05_svm_rr$f -cv 10 -lr 0.00001 -smi 1 --block_num $i --no_atten --dropout_rate 0.5 --loss_type svm --svm_rankratio $rr
#    done
#done
